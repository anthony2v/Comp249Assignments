...
public class Tram extends CityBus {
    ...
    public Tram(Tram otherTram){
        this(otherTram.getTicketPrice(), otherTram.getNumberOfStops(), otherTram.routeNumber, otherTram.beginOperationYear,
                otherTram.lineName, otherTram.driverName, otherTram.maximumSpeed);
    }
    /**
